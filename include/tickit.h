...
typedef int TickitPenEventFn(TickitPen *tt, TickitEventType ev, TickitEventInfo *args, void *data);
...
typedef int TickitTermEventFn(TickitTerm *tt, TickitEventType ev, TickitEventInfo *args, void *data);
